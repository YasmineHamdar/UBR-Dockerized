...
input_path = "/home/yhh05/smogN/Library_Daily_Albedo_NDVI_LST_Cleaned.csv"
...
#                  'ETo', 'EToF', 'ETr', 'ETrF', 'SW_IN', 'Site_1', 'Site_2', 'Site_3', 'Site_4', 'Site_5',
#                  'Site_6']            
...
#clustered
#columnsToDrop = ['Site_1', 'Site_2', 'Site_3', 'Site_4', 'Site_5',
#                 'Site_6', 'Cluster', 'Climate_0', 'Climate_1',
#                 'Climate_2', 'Climate_3']
...
def calculate_std_error_metrics(acc_folds_2 , aic_folds_2 , bic_folds_2 , nmi_folds_2 , mape_folds_2 , dist_folds_2 ,spearman_folds_2, pearson_folds_2, mae_folds_2,mse_folds_2, rmse_folds_2, ar2_folds_2, r2_folds_2, f1_folds_2, f2_folds_2, f5_folds_2,prec_folds_2,rec_folds_2,folds):
  ...
  std_recall = np.std(recall_folds_2 )
...
df_train.to_csv(output_path + "df_train_full.csv")
df_test.to_csv(output_path + "df_test_full.csv")
...
if grid_search:
   ...
   for param in grid_needed:
       ...
       for rep in range(repetitions):
           ...
           scores_dict["Spatial Distance"] =  std_distance
...
if smogn:
   print("The size of the original data is " + str(size_original), file=open(output_path +"smogn_stats.txt", "a"))
   print("The size of the oversampled data is " + str(df_train_smogned.shape), file=open(output_path +"smogn_stats.txt", "a"))
   ...
   print("The percentage of rare values in dataset after smogn are "  + str(rare_train_after), file=open(output_path +"smogn_stats.txt", "a"))
