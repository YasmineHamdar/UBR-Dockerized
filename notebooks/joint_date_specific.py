...
input_path = "/home/yhh05/smogN/All_Library_Joint.csv"
...
columnsToDrop = ['Day', 'Date',
                 ...
                 'ET_bowen_corr_mm', 'ETo', 'EToF_bowen', 'EToF_ebr', 'ETrF_bowen',
                 'ETrF_ebr', 'Eeflux_ETo', 'Eeflux_ETr',
                 'Eeflux_EToF', 'Eeflux_ETrF', 'SW_IN', 'LE_ebr_corr(mm)']
...
df.drop(columns=[ 'Vegetation', 'Month_0', 'Vegetation_0', 'Site_0'], inplace=True)
print(df.columns)
print(df.shape)
...
#split into train and test according to special split
X_train, X_test, y_train, y_test = split_train_test_valid_date(df, 7)
print(X_train.shape)
print(y_train.shape)
#dropping site id after filtering the sites
columnToDrop = ["Site", 'Month', 'Year']
